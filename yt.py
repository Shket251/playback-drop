...
Ритм тот же, что и дома, и он тут ГЛАВНОЕ: два поста в сутки на канал и пауза между
ними. Раскладывает его расписание (yt.yml зовёт эту смену дважды в день в разное
время), а держит — `posted_yt.json`: смена, пришедшая слишком рано, просто уходит ни
с чем. Пачка подряд читается как спам, а алгоритму нужна регулярность.
...
PER_DAY = 2             # постов в сутки на канал: тот же потолок, что и дома
